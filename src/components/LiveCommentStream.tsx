...
export function LiveCommentStream({
  ...
  const sampleQuickComments = [
    { name: 'ស្រីនាង កំពង់ចាម', text: '30=2 យកពណ៍ផ្ទៃមេឃ 012334455 កំពង់ចាម' },
    { name: 'សុភ័ក្ត្រ ភ្នំពេញ', text: 'កាត់ A12 មួយ និង 54=2 ភ្នំពេញ 098776655' },
    { name: 'ចិន្តា សៀមរាប', text: 'ថែម K99 មួយទៀតចែ' },
    { name: 'ធីតា ផ្សារថ្មី', text: '88=1 size 38 088991122 ភ្នំពេញ' }
  ];
